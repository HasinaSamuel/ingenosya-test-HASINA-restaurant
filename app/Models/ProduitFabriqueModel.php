...
class ProduitFabriqueModel extends Model
{
	protected $DBGroup              = 'default';
	protected $table                = 'produit_fabrique';
	protected $primaryKey           = 'IdFabrication';
	protected $useAutoIncrement     = true;
	protected $insertID             = 0;
	protected $returnType           = 'array';
	protected $useSoftDeletes       = false;
	protected $protectFields        = true;
	protected $allowedFields        = ['IdMenu', 'DateFabrication', 'QteFabrique'];
